...
const readNotes = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const listNotes = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const removeNoteById = (noteId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const notesList = yield readNotes();
...
const updateNoteById = (noteId, body) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const notesList = yield readNotes();
